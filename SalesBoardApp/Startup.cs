...
using SalesBoardApp.Authorization;
using SalesBoardApp.Models;

namespace SalesBoardApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SalesBoardAppContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("SalesBoardAppContextConnection")));

            services.AddDefaultIdentity<SalesBoardAppUser>().AddRoles<IdentityRole>()
